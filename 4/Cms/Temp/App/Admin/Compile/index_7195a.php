...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/test/4/Cms/App/Admin/Tpl/Index/css/css.css"/>
    <script type="text/javascript" src="http://localhost/test/4/Cms/App/Admin/Tpl/Index/js/js.js"></script>
    <base target='iframe'/>
</head>
<body>
<div class="nav">
    ...
    <div class="r_menu">
        ...
        <a href="http://localhost/test/4/index.php" target="_blank">前台首页</a>
    </div>
    <!--头部右侧导航-->
</div>
<!--左侧导航-->
